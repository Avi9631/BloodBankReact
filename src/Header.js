...
import AdminLogin from './AminLoginModal'
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light">
                      ...
                      <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                          ...
                          <li className="nav-item">
                            <a className="nav-link">
                              {disableVar ? <Link to="/" onClick={() => alert("You are not Logged In")}>Blood Bank</Link> : <Link to="/stock">Blood Bank</Link>}
                            </a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link">
                              {disableVar ? <Link to="/" onClick={() => alert("You are not Logged In")}>Find Donors</Link> : <Link to="/donor">Find Donors</Link>}
                            </a>
                          </li>
